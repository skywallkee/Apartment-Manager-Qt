...
#include "ui_Apartment_Manager_Qt.h"
#include <QHBoxLayout>
#include <QVBoxLayout>
#include "Service.h"
#include <QListWidget>
...
class Apartment_Manager_Qt : public QMainWindow, public Observable
{
	Q_OBJECT

public:
	Apartment_Manager_Qt(Service& sv, QWidget *parent = Q_NULLPTR);

private:
	Service& serv;
	Ui::Apartment_Manager_QtClass ui;
	void init_gui_comps();
